...
This document describes the 0.004 version of the metamodel used in the
OpenResty 0.3.4.
...
The C<name> column keeps the names of user models' columns and the C<table_name>
...
and in addition, the combination of the columns C<table_name> and C<name> should
be unique.
